...
'PONTO DE INICIO DA REPETIÇÃO__________________________________________________________________________________________________________________
For lContador = 2 To lUltimaLinhaAtiva
    ...
    If Range("G" & lContador) = "" Then
        ...
        If driver.FindElementByXPath("//*[@id='btnSituacaoServico']").Text = "Pendente" Then
            ...
            'TIRAR FÓRMULA, COLAR VALORES_______________________________________________________________________________________________________________________________________________
            Range("N" & lContador & ":" & "AA" & lContador).Select
            Selection.Copy
            Selection.PasteSpecial Paste:=xlPasteValues, Operation:=xlNone, SkipBlanks:=False, Transpose:=False
            'INICIAR O PROCESSO DE FINALIZAÇÃO__________________________________________________________________________________________________________________________
            ...
            driver.FindElementByXPath("//*[@id='detalhesErroSpan']").Click
                If Err.Number = "7" Then
                    ...
                    On Error GoTo 0 '#CHECKPOIT
                    'CODIGO DE FINALIZAÇÃO___________________________________________________________________________________________________________________________________
                    ...
                    'AÇÃO DE FINALIZAR____________________________________________________________________________________________________________________________________________________
